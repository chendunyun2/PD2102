...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    ...
                    -344, // TUNGSTEN UpperBound
                    -450  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -213, // WARM FLUORESCENT RightBound
                    -910, // WARM FLUORESCENT LeftBound
                    -450, // WARM FLUORESCENT UpperBound
                    -595  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                     -53, // FLUORESCENT RightBound
                    -213, // FLUORESCENT LeftBound
                    -334, // FLUORESCENT UpperBound
                    -483  // FLUORESCENT LowerBound
                },
                // CWF
                {
                     -23, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     138, // DAYLIGHT RightBound
                     -53, // DAYLIGHT LeftBound
                    -334, // DAYLIGHT UpperBound
                    -483  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     368, // SHADE RightBound
                     138, // SHADE LeftBound
                    -334, // SHADE UpperBound
                    -450  // SHADE LowerBound
                },
                // DF
                {
                     138, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     263, // CLOUDY_D RightBound
                      88, // CLOUDY_D LeftBound
                    -334, // CLOUDY_D UpperBound
                    -483  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     363, // SHADE RightBound
                      88, // SHADE LeftBound
                    -334, // SHADE UpperBound
                    -483  // SHADE LowerBound
                },
                // TWILIGHT
                {
                     -53, // TWILIGHT RightBound
                    -213, // TWILIGHT LeftBound
                    -334, // TWILIGHT UpperBound
                    -483  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     158, // FLUORESCENT RightBound
                    -218, // FLUORESCENT LeftBound
                    -364, // FLUORESCENT UpperBound
                    -555  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -256, // WARM FLUORESCENT RightBound
                    -456, // WARM FLUORESCENT LeftBound
                    -364, // WARM FLUORESCENT UpperBound
                    -555  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -256, // INCANDESCENT RightBound
                    -456, // INCANDESCENT LeftBound
                    -334, // INCANDESCENT UpperBound
                    -483  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                ...
                {
                    -618,  // RotatedXCoordinate0
                    -464,  // RotatedXCoordinate1
                    -226,  // RotatedXCoordinate2
