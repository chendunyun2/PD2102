...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0416)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0728)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0325)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0325)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0585)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0559)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0403)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0325)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0416)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0325)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0741)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0598)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0416)
