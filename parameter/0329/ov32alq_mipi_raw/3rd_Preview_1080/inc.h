 ...
 ************************************************************************************************/
#ifndef _3RD_PREVIEW_1080_H
#define _3RD_PREVIEW_1080_H
...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0793)
...
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0598)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0468)
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0806)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0663)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0481)
