 ...
 ************************************************************************************************/
#ifndef _FACEBEAUTY_FLASH_CAPTURE_H
#define _FACEBEAUTY_FLASH_CAPTURE_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0260)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0429)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0208)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0208)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0338)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0351)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0234)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0208)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0260)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0208)
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_0273)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0455)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0351)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0377)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0130)
...
#define AKS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, AKS_0273)
#define SW_MSF_ISP_MFNR_BASE                                         M_CONC(TARGET_SENSOR, SW_MSF_0052)
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0156)
#define OMC_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, OMC_0052)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0442)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0364)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0143)
