...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0351)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0182)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0182)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0286)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0286)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0208)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0182)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0221)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0182)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0364)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0299)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0104)
