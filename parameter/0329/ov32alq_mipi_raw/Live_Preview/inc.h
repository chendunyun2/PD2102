...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0481)
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0494)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0390)
