 ...
 ************************************************************************************************/
#ifndef _FACE_CAPTURE_4CELL_H
#define _FACE_CAPTURE_4CELL_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0052)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0091)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0039)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0039)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0065)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0078)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0039)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0039)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0052)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0039)
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_0065)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0104)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0078)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0091)
...
#define AKS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, AKS_0065)
#define SW_MSF_ISP_MFNR_BASE                                         M_CONC(TARGET_SENSOR, SW_MSF_0013)
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0039)
