 ...
 ************************************************************************************************/
#ifndef _3RD_PREVIEW_720_H
#define _3RD_PREVIEW_720_H
...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0819)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0676)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0611)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0494)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0377)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0468)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0377)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0832)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0689)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0507)
