 ...
 ************************************************************************************************/
#ifndef _3RD_CAPTURE_1080_H
#define _3RD_CAPTURE_1080_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0481)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0845)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0390)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0390)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0702)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0624)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0520)
