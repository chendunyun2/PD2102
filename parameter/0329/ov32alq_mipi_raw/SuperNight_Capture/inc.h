...
#define AE_AE_BASE                                                   M_CONC(TARGET_SENSOR, AE_0011)
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0533)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0923)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0442)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0442)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0767)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0689)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0585)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0442)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0533)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0442)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0936)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0702)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0247)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0012)
...
#define FUS_ISP_Other_BASE                                           M_CONC(TARGET_SENSOR, FUS_0026)
#define ZFUS_ISP_Other_BASE                                          M_CONC(TARGET_SENSOR, ZFUS_0026)
...
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0005)
