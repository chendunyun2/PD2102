 ...
 ************************************************************************************************/
#ifndef _WECHATQQ_CALL_H
#define _WECHATQQ_CALL_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0403)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0702)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0312)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0312)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0559)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0546)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0377)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0312)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0403)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0312)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0715)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0572)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0390)
