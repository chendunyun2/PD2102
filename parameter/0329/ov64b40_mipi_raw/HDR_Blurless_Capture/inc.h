 ...
 ************************************************************************************************/
#ifndef _HDR_BLURLESS_CAPTURE_H
#define _HDR_BLURLESS_CAPTURE_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0415)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0750)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0359)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0359)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0669)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0496)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0557)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0359)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0415)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0359)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0764)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0510)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0137)
