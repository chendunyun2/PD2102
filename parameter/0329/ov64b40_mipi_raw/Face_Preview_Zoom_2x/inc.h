 ...
 ************************************************************************************************/
#ifndef _FACE_PREVIEW_ZOOM_2X_H
#define _FACE_PREVIEW_ZOOM_2X_H
...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0584)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0243)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0243)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0531)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0352)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0419)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0243)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0299)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0243)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0595)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0542)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0430)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0176)
