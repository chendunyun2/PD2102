...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0189)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0364)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0133)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0133)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0311)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0242)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0199)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0133)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0189)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0133)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0375)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0322)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0210)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0066)
...
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0010)
