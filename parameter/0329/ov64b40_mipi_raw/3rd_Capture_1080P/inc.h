 ...
 ************************************************************************************************/
#ifndef _3RD_CAPTURE_1080P_H
#define _3RD_CAPTURE_1080P_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0033)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0066)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0033)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0033)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0066)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0033)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0066)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0033)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0033)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0033)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0077)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0044)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0000)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0000)
#define CA_LTM_CA_LTM_BASE                                           M_CONC(TARGET_SENSOR, CA_LTM_0003)
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0003)
...
extern const ISP_NVRAM_YNR_T                                         YNR_ISP_LPNR_BASE[11];
extern const ISP_NVRAM_EE_T                                          EE_ISP_LPNR_BASE[11];
extern const FEATURE_NVRAM_MSYUV_T                                   MSYUV_ISP_LPNR_BASE[11];
