...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0016)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0016)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0016)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0016)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0016)
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0016)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0863)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_1646)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0779)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0779)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_1420)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_1089)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_1252)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0779)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0863)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0779)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_1660)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_1103)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0310)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0017)
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0017)
