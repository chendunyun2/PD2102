...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {1145, 405, 758, -387};
    FLICKER_CUST_STATISTICS EV60_L50 = {1367, 427, 1127, -461};
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 90, 100, 120, 130, 160, 170, 190, 210};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1123, 414, 773, -392};
    FLICKER_CUST_STATISTICS EV60_L50 = {1323, 441, 1164, -470};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1421;
...
static void get_flicker_para_by_Video_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1331;
...
static void get_flicker_para_by_Video_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1433;
...
static void get_flicker_para_by_Video1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {59, 7859, 14679, -1146};
    FLICKER_CUST_STATISTICS EV60_L50 = {100, 5802, 15316, -1129};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1331;
...
static void get_flicker_para_by_Video1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {56, 8286, 15476, -1159};
    FLICKER_CUST_STATISTICS EV60_L50 = {95, 6147, 16228, -1144};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1357;
...
static void get_flicker_para_by_Video2_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {24, 19270, 35994, -1375};
    FLICKER_CUST_STATISTICS EV60_L50 = {39, 14882, 39286, -1370};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1337;
    para->flickerSearchRange = 8;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {22, 20852, 38948, -1396};
    FLICKER_CUST_STATISTICS EV60_L50 = {36, 16134, 42591, -1391};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Custom1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1251, 466, 1232, -484};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Custom1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 110, 120, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1003, 463, 866, -421};
    FLICKER_CUST_STATISTICS EV60_L50 = {1212, 481, 1271, -492};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1428;
...
static void get_flicker_para_by_Custom2_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {407, 1140, 2130, -652};
    FLICKER_CUST_STATISTICS EV60_L50 = {581, 1004, 2650, -680};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1319;
...
static void get_flicker_para_by_Custom2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {395, 1177, 2199, -660};
    FLICKER_CUST_STATISTICS EV60_L50 = {579, 1008, 2662, -681};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1383;
    para->flickerSearchRange = 16;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom3_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {2982, 155, 291, -142};
    FLICKER_CUST_STATISTICS EV60_L50 = {3827, 152, 402, -198};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1347;
    para->flickerSearchRange = 116;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
    para->EV50_L60 = EV50_L60;
...
static void get_flicker_para_by_Custom3_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 80, 90, 100, 110, 120, 130, 140, 170};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {2946, 157, 294, -145};
    FLICKER_CUST_STATISTICS EV60_L50 = {3764, 155, 409, -202};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Custom5_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1009, 460, 860, -420};
...
static void get_flicker_para_by_Custom5_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1513;
    para->flickerSearchRange = 20;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
