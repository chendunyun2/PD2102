 ...
 ************************************************************************************************/
#ifndef _WECHATQQ_VIDEOCALL_H
#define _WECHATQQ_VIDEOCALL_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0011)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0022)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0011)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0011)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0022)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0011)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0022)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0011)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0011)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0011)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0033)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0033)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0033)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0011)
