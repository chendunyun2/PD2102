 ...
 ************************************************************************************************/
#ifndef _PROFESSIONAL_PREVIEW_ZOOM_4X_H
#define _PROFESSIONAL_PREVIEW_ZOOM_4X_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0376)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0683)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0320)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0320)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0630)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0429)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0518)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0320)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0376)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0320)
