 ...
 ************************************************************************************************/
#ifndef _3RD_PREVIEW_1080P_H
#define _3RD_PREVIEW_1080P_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0044)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0088)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0044)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0044)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0077)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0055)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0077)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0044)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0044)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0044)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0099)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0088)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0088)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0033)
