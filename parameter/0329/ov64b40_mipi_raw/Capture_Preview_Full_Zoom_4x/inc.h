 ...
 ************************************************************************************************/
#ifndef _CAPTURE_PREVIEW_FULL_ZOOM_4X_H
#define _CAPTURE_PREVIEW_FULL_ZOOM_4X_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0266)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0518)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0210)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0210)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0465)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0319)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0353)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0210)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0266)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0210)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0529)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0476)
