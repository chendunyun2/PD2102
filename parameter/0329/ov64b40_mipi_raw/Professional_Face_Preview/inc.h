 ...
 ************************************************************************************************/
#ifndef _PROFESSIONAL_FACE_PREVIEW_H
#define _PROFESSIONAL_FACE_PREVIEW_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0343)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0650)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0287)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0287)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0597)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0396)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0485)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0287)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0343)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0287)
