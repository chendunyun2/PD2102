 ...
 ************************************************************************************************/
#ifndef _VIDEO_1080P_120FPS_H
#define _VIDEO_1080P_120FPS_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0451)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0822)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0395)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0395)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0727)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0546)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0615)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0395)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0451)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0395)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0833)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0738)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0626)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0220)
