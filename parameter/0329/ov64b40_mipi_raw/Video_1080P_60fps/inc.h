 ...
 ************************************************************************************************/
#ifndef _VIDEO_1080P_60FPS_H
#define _VIDEO_1080P_60FPS_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0594)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_1108)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0538)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0538)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_1013)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0689)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0901)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0538)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0594)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0538)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_1119)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_1024)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0912)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0363)
