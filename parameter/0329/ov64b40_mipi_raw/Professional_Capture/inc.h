...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0715)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_1350)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0659)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0659)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_1222)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0843)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_1110)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0659)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0715)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0659)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_1364)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0857)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0184)
