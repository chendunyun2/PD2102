 ...
 ************************************************************************************************/
#ifndef _SCENE_CAPTURE_MACRO_H
#define _SCENE_CAPTURE_MACRO_H
...
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0052)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0039)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0039)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0026)
...
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0026)
