...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0156)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0130)
...
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0143)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0130)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0065)
...
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0091)
#define OMC_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, OMC_0052)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0169)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0117)
