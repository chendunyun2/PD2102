 ...
 ************************************************************************************************/
#ifndef _SCENE_PREVIEW_FULL_MACRO_H
#define _SCENE_PREVIEW_FULL_MACRO_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0130)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0260)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0221)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0169)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0065)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0052)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0130)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0052)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0273)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0234)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0078)
