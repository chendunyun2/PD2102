 ...
 ************************************************************************************************/
#ifndef _FACE_CAPTURE_MACRO_H
#define _FACE_CAPTURE_MACRO_H
...
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0130)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0104)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0091)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0052)
