...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0195)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0390)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0117)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0117)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0351)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0234)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0195)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0117)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0195)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0117)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0403)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0364)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0208)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0078)
#define OBC_ISP_RAW_BASE                                             M_CONC(TARGET_SENSOR, OBC_0026)
#define BPC_BPC_ISP_RAW_BASE                                         M_CONC(TARGET_SENSOR, BPC_BPC_0026)
#define BPC_CT_ISP_RAW_BASE                                          M_CONC(TARGET_SENSOR, BPC_CT_0026)
#define BPC_PDC_ISP_RAW_BASE                                         M_CONC(TARGET_SENSOR, BPC_PDC_0026)
#define LDNR_ISP_RAW_BASE                                            M_CONC(TARGET_SENSOR, LDNR_0104)
