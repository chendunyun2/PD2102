...
#choose flicker parameter
MY_AUTOGEN_FLICKER_PARA := $(TOP)/$(PRODUCT_OUT)/obj_arm/GYP/flicker_intermediates/imgsensor/$(LOCAL_MODULE_NAME)/camera_flicker_para_$(subst _,,$(LOCAL_MODULE_NAME)).cpp
MY_AUTOGEN_FLICKER_PARA_EXIST := $(shell test -f $(MY_AUTOGEN_FLICKER_PARA) && echo yes)

ifeq ($(MY_AUTOGEN_FLICKER_PARA_EXIST),yes)
MY_FLICKER_PARA_NAME := camera_flicker_para_$(subst _,,$(LOCAL_MODULE_NAME)).cpp
LOCAL_filter += $(MY_FLICKER_PARA_NAME)
LOCAL_SRC_FILES += ../../../../../../../../../$(MY_AUTOGEN_FLICKER_PARA)
else
$(info [Flicker] Using original flicker parameter for $(LOCAL_MODULE_NAME))
endif
