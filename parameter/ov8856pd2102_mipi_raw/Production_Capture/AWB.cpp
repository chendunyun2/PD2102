...
const AWB_NVRAM_T AWB_BASE[1] = {
	...
	/******************************************************************************/
			// AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
			{
                ...
                {{  85,  85,  85,  85,  82,  88,  88,  85,  84,  84,  88,  95,  95,  95,  90,  75,  75,  75,  50,  25,  10,  10,  10}}, // TUNGSTEN
                {{  80,  80,  80,  81,  89,  94,  95,  93,  84,  84,  83,  90,  90,  90,  75,  75,  50,  25,  25,  25,   0,   0,   0}}, // WARM FLUORESCENT
                {{  70,  70,  70,  70,  80,  90,  90,  85,  80,  76,  85,  92,  92,  90,  77,  74,  74,  73,  71,  70,  67,  25,  25}}, // FLUORESCENT
                {{  80,  80,  80,  81,  85,  90,  90,  86,  87,  90,  90,  92,  96,  96,  96,  80,  70,  30,  30,  30,   0,   0,   0}}, // CWF
				...
				// AWB light source preference gain LUT
				{
					{ // TUNGSTEN
						...
						{ // LUT: use (green offset - thld) as index
						  //  0  100  200  300  400  500  600  700  800  900 1000
                            {504, 520}, {504, 520}, {512, 512}, {512, 512}, {512, 512}, {512, 512}, {512, 512}, {512, 512}, {512, 512}, {512, 512}, {512, 512}
						},
					},
					{ // WARM FLUORESCENT
						{ // LUT: use ratio offset as index
