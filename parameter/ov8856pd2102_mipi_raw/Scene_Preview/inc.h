...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0143)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0286)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0065)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0065)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0247)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0182)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0091)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0065)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0143)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0065)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0299)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0260)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0104)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0026)
...
#define LDNR_ISP_RAW_BASE                                            M_CONC(TARGET_SENSOR, LDNR_0091)
