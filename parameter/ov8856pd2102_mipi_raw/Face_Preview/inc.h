...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0169)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0338)
...
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0208)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0143)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0091)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0169)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0091)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0351)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0312)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0156)
