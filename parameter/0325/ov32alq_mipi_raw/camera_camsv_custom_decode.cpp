...
CAMSV_CUSTOM_BUFFER_INFO getAeBufSize_ov32alqmipiraw();
CAMSV_CUSTOM_BUFFER_INFO getFlkBufsize_ov32alqmipiraw();
UINT32 DecodeAe_ov32alqmipiraw(VOID* const pData);
UINT32 DecodeFlk_ov32alqmipiraw(VOID* const pData);
...
impCamsvBufSize(CAMSV_CUSTOM_DECODE_ENUM const CamsvCusDecodeFeature) const
{
    ...
    switch(CamsvCusDecodeFeature)
    {
        case CAMSV_CUSTOM_DECODE_AE:
            buf_size = getAeBufSize_ov32alqmipiraw();
            break;
        case CAMSV_CUSTOM_DECODE_FLK:
            buf_size = getFlkBufsize_ov32alqmipiraw();
            break;
        default:
...
impCamsvCustomDecode(CAMSV_CUSTOM_DECODE_ENUM const CamsvCusDecodeFeature, VOID* const pData) const
{
    ...
    {
        case CAMSV_CUSTOM_DECODE_AE:
            DecodeAe_ov32alqmipiraw(pData);
            break;
        case CAMSV_CUSTOM_DECODE_FLK:
            DecodeFlk_ov32alqmipiraw(pData);
            break;
        default:
...
UINT32 DecodeAe_ov32alqmipiraw(VOID* const pData)
{
    ...
    CAMSV_CUSTOM_BUFFER_INFO buf = getAeBufSize_ov32alqmipiraw();
...
UINT32 DecodeFlk_ov32alqmipiraw(VOID* const pData)
{
    ...
    CAMSV_CUSTOM_BUFFER_INFO buf = getFlkBufsize_ov32alqmipiraw();
    memset(pOutput, 0, buf.size * sizeof(MUINT32));
