 ...
 ************************************************************************************************/
#ifndef _TIKTOK_CAPTURE_H
#define _TIKTOK_CAPTURE_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0442)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0780)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0351)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0351)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0637)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0585)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0455)
