...
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0010)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0520)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0897)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0429)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0429)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0741)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0676)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0559)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0429)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0520)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0429)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0910)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0754)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0572)
