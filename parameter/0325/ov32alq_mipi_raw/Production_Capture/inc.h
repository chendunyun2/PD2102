...
#define AE_AE_BASE                                                   M_CONC(TARGET_SENSOR, AE_0009)
...
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0009)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0507)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0871)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0416)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0416)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0728)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0650)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0546)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0416)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0507)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0416)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0884)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0663)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0234)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0011)
...
#define LDNR_ISP_RAW_BASE                                            M_CONC(TARGET_SENSOR, LDNR_0169)
