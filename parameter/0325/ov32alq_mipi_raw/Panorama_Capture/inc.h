...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0585)
...
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0598)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0468)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0195)
