...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0559)
...
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0442)
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0572)
