 ...
 ************************************************************************************************/
#ifndef _FACEBEAUTY_CAPTURE_4CELL_H
#define _FACEBEAUTY_CAPTURE_4CELL_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0117)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0195)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0156)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0156)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0104)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0091)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0117)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0091)
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_0130)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0208)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0169)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0169)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0078)
#define CNR_CCR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CCR_0039)
#define CNR_ABF_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_ABF_0039)
...
#define AKS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, AKS_0130)
#define SW_MSF_ISP_MFNR_BASE                                         M_CONC(TARGET_SENSOR, SW_MSF_0026)
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0065)
