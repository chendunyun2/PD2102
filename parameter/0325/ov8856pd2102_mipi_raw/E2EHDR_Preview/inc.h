 ...
 ************************************************************************************************/
#ifndef _E2EHDR_PREVIEW_H
#define _E2EHDR_PREVIEW_H
...
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0008)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0247)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0468)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0156)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0156)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0403)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0299)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0247)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0156)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0234)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0156)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0481)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0416)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0260)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0091)
#define CNR_CCR_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_CCR_0104)
#define CNR_ABF_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_ABF_0104)
...
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0004)
#define GGM_E2E_GGM_E2E_BASE                                         M_CONC(TARGET_SENSOR, GGM_E2E_0000)
...
extern const ISP_NVRAM_GGM_E2E_STRUCT_T                              GGM_E2E_GGM_E2E_BASE[1];
