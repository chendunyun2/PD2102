...
const ISP_NVRAM_MULTI_CCM_STRUCT CCM_BASE[6] = {
    // IDX_0
    {
        ...
        {
            {.set={//CT_00
            0x1EFD0334, 0x00001FCF, 0x02F91F26, 0x00001FE1, 0x1CB51F5A, 0x000005F1
			}},
			{.set={//CT_01
				0x1EB50326, 0x00000025, 0x02D01F24, 0x0000000C, 0x1C801F58, 0x00000628
			}},
			{.set={//CT_02
				0x1E1A0400, 0x00001FE6, 0x03131F44, 0x00001FA9, 0x1DC21FDE, 0x00000460
			}},
			{.set={//CT_03
