 ...
 ************************************************************************************************/
#ifndef _SCENE_PREVIEW_FULL_H
#define _SCENE_PREVIEW_FULL_H
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0247)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0208)
