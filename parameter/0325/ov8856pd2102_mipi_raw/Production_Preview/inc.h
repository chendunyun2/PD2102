...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0011)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0011)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0011)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0011)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0011)
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0011)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0325)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0598)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0520)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0390)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0364)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0234)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0312)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0234)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0611)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0533)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0377)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0130)
...
#define LDNR_ISP_RAW_BASE                                            M_CONC(TARGET_SENSOR, LDNR_0117)
