...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0208)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0416)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0130)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0130)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0377)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0247)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0221)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0130)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0208)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0130)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0429)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0260)
...
#define CNR_CCR_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_CCR_0091)
#define CNR_ABF_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_ABF_0091)
#define FUS_ISP_Other_BASE                                           M_CONC(TARGET_SENSOR, FUS_0013)
#define ZFUS_ISP_Other_BASE                                          M_CONC(TARGET_SENSOR, ZFUS_0013)
