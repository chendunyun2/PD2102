 ...
 ************************************************************************************************/
#ifndef _RECORDING_CAPTURE_H
#define _RECORDING_CAPTURE_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0312)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0572)
...
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0364)
...
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0585)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0377)
