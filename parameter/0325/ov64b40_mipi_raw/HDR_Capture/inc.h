...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0387)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0694)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0331)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0331)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0641)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0440)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0529)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0331)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0387)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0331)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0708)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0454)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0109)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0004)
#define CA_LTM_CA_LTM_BASE                                           M_CONC(TARGET_SENSOR, CA_LTM_0011)
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0011)
