...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0019)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0019)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0019)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0019)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0019)
#define GMA_R3_TONE_BASE                                             M_CONC(TARGET_SENSOR, GMA_R3_0019)
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_1087)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_2094)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0919)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0919)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_1728)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_1453)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_1392)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0919)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_1087)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0919)
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_1101)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_2122)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_1742)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_1481)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0254)
#define CNR_CCR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CCR_0266)
#define CNR_ABF_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_ABF_0266)
#define MFNR_THRES_ISP_MFNR_BASE                                     M_CONC(TARGET_SENSOR, MFNR_THRES_0012)
#define MFNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, MFNR_0168)
#define BSS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, BSS_0168)
#define AKS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, AKS_1101)
#define SW_MSF_ISP_MFNR_BASE                                         M_CONC(TARGET_SENSOR, SW_MSF_0168)
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0548)
#define OMC_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, OMC_0168)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_2108)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_1467)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0534)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0027)
#define CA_LTM_CA_LTM_BASE                                           M_CONC(TARGET_SENSOR, CA_LTM_0022)
...
#define ClearZoom_ClearZoom_BASE                                     M_CONC(TARGET_SENSOR, ClearZoom_0022)
#define YNR_TBL_ISP_YNR_TBL_BASE                                     M_CONC(TARGET_SENSOR, YNR_TBL_0014)
