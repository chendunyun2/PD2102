 ...
 ************************************************************************************************/
#ifndef _FACEBEAUTY_HDR_CAPTURE_H
#define _FACEBEAUTY_HDR_CAPTURE_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0401)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0722)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0345)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0345)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0655)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0468)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0543)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0345)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0401)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0345)
#define YNR_ISP_LPNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0736)
#define EE_ISP_LPNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0482)
#define MSYUV_ISP_LPNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0123)
#define MSNR_THRES_ISP_LPNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0005)
