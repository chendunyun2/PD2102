...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0638)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_1196)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0582)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0582)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_1101)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0733)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0989)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0582)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0638)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0582)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_1207)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_1112)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_1000)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0407)
