 ...
 ************************************************************************************************/
#ifndef _WECHATQQ_VIDEO_H
#define _WECHATQQ_VIDEO_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0022)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0044)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0022)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0022)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0044)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0022)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0044)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0022)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0022)
#define AD_NR_ISP_YUV_BASE                                           M_CONC(TARGET_SENSOR, AD_NR_0022)
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0055)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0055)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0055)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0022)
